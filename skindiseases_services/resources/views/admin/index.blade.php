      ...
      <div class="wrapper">
         ...
         <div class="iq-sidebar">
            <div class="iq-sidebar-logo d-flex justify-content-between">
               ...
               <img src="{{ asset ('core/images/logo.png')}}" class="img-fluid" alt="">
               <span style ="font-size:24px;">Skin-Diases</span>
               </a>
            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li><a href="{{ route('dashboard.index') }}" class="iq-waves-effect"><i class="ri-chat-check-line"></i><span>Dashboard</span></a></li>
                     <li><a href="{{ route('produk.index') }}" class="iq-waves-effect"><i class="ri-chat-check-line"></i><span>Product</span></a></li>
                     <li><a href="{{ route('article.index') }}" class="iq-waves-effect"><i class="ri-chat-check-line"></i><span>Article</span></a></li>
                     <li><a href="{{ route('recomentdation.index') }}" class="iq-waves-effect"><i class="ri-chat-check-line"></i><span>Recomentdation</span></a></li>
                  </ul>
               </nav>
               <div class="p-3"></div>
            </div>
            ...
            <div class="iq-navbar-custom">
               ...
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                                 ...
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{ asset ('core/images/user/01.jpg')}}" alt="">
                                          </div>
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{ asset ('core/images/user/02.jpg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{ asset ('core/images/user/03.jpg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{ asset ('core/images/user/04.jpg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="{{ asset ('core/images/user/05.jpg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                              ...
                              <div class="iq-card iq-card-block iq-card-stretch iq-card-height shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40" src="{{ asset ('core/images/small/jpg.svg')}}" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                  ...
                  <ul class="navbar-list">
                     <li>
                        <a href="#" class="search-toggle iq-waves-effect bg-primary text-white"><img src="{{ asset ('core/images/user/1.jpg')}}" class="img-fluid rounded" alt="user"></a>
